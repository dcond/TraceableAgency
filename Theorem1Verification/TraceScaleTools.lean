...
/-!
# Two-alternative surface of the Appendix-D trace scale

`PureTrace` exposes the Appendix-D conclusion for arbitrary finite block
...
/-- At one constant payoff, the Appendix-D theorem ranks every cross-channel,
...
theorem constantPayoff_pairWeak_iff_mutualInfo
  ...
  have hblock := constantPayoff_blockSameScale
