...
/-- Kernel-checked invocation of the Appendix-D theorem at a constant payoff. -/
...
/-- The same Appendix-D scale ranks every constant-payoff, block-supported
