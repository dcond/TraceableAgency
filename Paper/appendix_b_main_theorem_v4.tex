...
$L\succ_q E$; the strict part of Axiom~\textup{(A8)} makes the reverse public
...
\textup{(A8)} gives branchwise continuation.  These are precisely the
...
Support restriction and Axiom~\textup{(A8)}, including its strict part, give
\[
E\succeq_{\bar r_y}G
\quad\Longleftrightarrow\quad
