...
The two profiles share the continuation record alphabet within each branch, although $R_y$ may vary across branches;
their channels are otherwise unrestricted.
