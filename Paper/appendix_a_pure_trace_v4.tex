...
both are silent.  Equation~\eqref{eq:bridge-fair-binary} and branchwise
continuation give a strict comparison of the two compounds.  Full revelation
...
mixtures only by record labels.  If $(q,P)\succeq(q,Q)$, Axiom~\textup{(A8)}
...
strict clause of Axiom~\textup{(A8)} with the two continuation profiles
...
Axiom~\textup{(A8)} providing the essential cardinal alignment across reached
branches.
...
$p$.  If $P\succeq_pQ$, the weak clause of Axiom~\textup{(A8)} applied to
...
The strict clause of Axiom~\textup{(A8)} therefore gives
...
$\varepsilon i_B(\nu-\nu')$.  Axiom~\textup{(A8)}, support transport, and the
...
part of Axiom~\textup{(A8)} supplies both aggregate inequalities.  By
