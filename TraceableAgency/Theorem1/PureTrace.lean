...
import TraceableAgency.PureTrace.Theorem
...
theorem inducedPureNontriviality
    {O : Type u} [Fintype O] [DecidableEq O]
    (F : FixedPayoffPrefFamily O) (o : O)
    (h1 : A1_WeakOrder F)
...
theorem inducedPureClosedGraph
    {O : Type u} [Fintype O] [DecidableEq O]
    (F : FixedPayoffPrefFamily O) (o : O)
    (h2 : A2_Continuity F) :
    TraceableAgency.PureTraceClosedGraph (inducedPureTraceFamily F o) := by
...
theorem inducedPureFiniteBlock
    {O : Type u} [Fintype O] [DecidableEq O]
    (F : FixedPayoffPrefFamily O) (o : O)
    (h1 : A1_WeakOrder F)
    (h3 : A5_BlockComparisonCoherence F)
  ...
  have hrecord :
    ...
    fixed_rel_iff_of_mutualRecordProcessing F h1 h3 h4
      ...
      hforward hback _ _
  have hcore := inducedPureFiniteBlockNonempty F o h3
...
theorem inducedPureConditions_of_components
  ...
  closedGraph := inducedPureClosedGraph F o h2
  blockCoherence := ⟨inducedPureDuplication F o h3,
    inducedPureFiniteBlock F o h1 h3 h4 h5⟩
  recordProcessing := inducedPureRecordProcessing F o h4
  actionProcessing := inducedPureActionProcessing F o h5
...
theorem inducedPureRepresentation_of_components
    {O : Type u} [Fintype O] [DecidableEq O]
    (F : FixedPayoffPrefFamily O) (o : O)
    (h1 : A1_WeakOrder F)
    (h2 : A2_Continuity F)
...
theorem inducedPureBlocks_of_components
    {O : Type u} [Fintype O] [DecidableEq O]
    (F : FixedPayoffPrefFamily O) (o : O)
    (h1 : A1_WeakOrder F)
    (h2 : A2_Continuity F)
